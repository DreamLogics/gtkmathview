...
void
MathMLHorizBarNode::DoVerticalStretchyLayout(scaled height, scaled depth, scaled axis, bool strict)
{
...
void
MathMLHorizBarNode::DoHorizontalStretchyLayout(scaled desiredSize, bool strict)
{
